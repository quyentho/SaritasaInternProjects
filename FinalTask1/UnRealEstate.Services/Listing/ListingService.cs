...
namespace UnrealEstate.Services.Listing
{
    public class ListingService : IListingService
    {
        ...
        public ListingService(IListingRepository listingRepository, UserManager<ApplicationUser> userManager, IMapper mapper)
        {
